...
{
  if (($1 >= 0)) 
  then echo $(( ($1 >> $2) | ($1 << (64 - $2) ) ))
  else lshtmp=$(( ($1>>1)&0x7fffffffffffffff ))
    local tmp=$((tmp | 0x4000000000000000))
    tmp=$((lshtmp>>($2-1)))
